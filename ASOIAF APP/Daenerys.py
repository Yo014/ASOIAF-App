...
class DaenerysBookIII(ctk.CTkFrame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller
    ...
    def show_Daenerys_chapter(self):
        return {
            "Daenerys I": {"content": "Daenerys I: Daenerys sails to Astapor seeking an army.", "image": "Daenerys_Targaryen.png"},
            "Daenerys II": {"content": "Daenerys II: Daenerys negotiates for the Unsullied and plans her betrayal.", "image": "Daenerys_Targaryen.png"},
            "Daenerys III": {"content": "Daenerys III: Daenerys conquers Astapor and frees the Unsullied.", "image": "Daenerys_Targaryen.png"},
            "Daenerys IV": {"content": "Daenerys IV: Daenerys moves to conquer Yunkai with her new army.", "image": "Daenerys_Targaryen.png"},
            "Daenerys V": {"content": "Daenerys V: Daenerys defeats Yunkai and frees its slaves.", "image": "Daenerys_Targaryen.png"},
            "Daenerys VI": {"content": "Daenerys VI: Daenerys decides to stay and rule in Meereen rather than continue to Westeros.", "image": "Daenerys_Targaryen.png"},
        }
