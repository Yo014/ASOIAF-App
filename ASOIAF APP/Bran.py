...
## book3
class BranBookIII(ctk.CTkFrame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller
    ...
    def create_slider(self):
        self.slider = ctk.CTkSlider(
            self,
            from_=1, to=4, number_of_steps=3,
            command=self.slider_changed,
            width=400,
            progress_color="dark green",
            button_color="white",
    ...
    def show_Bran_chapter(self):
        return {
            "Bran I": {"content": "Bran I: Bran hides in the crypts of Winterfell after Theon's betrayal.", "image": "Bran_Stark.png"},
            "Bran II": {"content": "Bran II: Bran flees Winterfell with Hodor, Meera, and Jojen Reed.", "image": "Bran_Stark.png"},
            "Bran III": {"content": "Bran III: Bran travels north beyond the Wall, struggling with his wolf dreams.", "image": "Bran_Stark.png"},
            "Bran IV": {"content": "Bran IV: Bran uses his greenseer powers and reaches the Nightfort.", "image": "Bran_Stark.png"},
        }
