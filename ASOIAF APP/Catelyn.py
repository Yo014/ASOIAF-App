...
class CatelynBookIII(ctk.CTkFrame):
    def __init__(self, parent, controller):
        super().__init__(parent)
        self.controller = controller
    ...
    def show_Catelyn_chapter(self):
        return {
            "Catelyn I": {"content": "Catelyn I: Catelyn deals with Robb’s political marriage issues.", "image": "Catelyn_Stark.png"},
            "Catelyn II": {"content": "Catelyn II: Catelyn advises Robb on war strategy.", "image": "Catelyn_Stark.png"},
            "Catelyn III": {"content": "Catelyn III: Catelyn discusses alliance possibilities after Renly’s death.", "image": "Catelyn_Stark.png"},
            "Catelyn IV": {"content": "Catelyn IV: Catelyn attends her father’s funeral at Riverrun.", "image": "Catelyn_Stark.png"},
            "Catelyn V": {"content": "Catelyn V: Catelyn speaks with Edmure Tully about Frey obligations.", "image": "Catelyn_Stark.png"},
            "Catelyn VI": {"content": "Catelyn VI: Catelyn grows increasingly concerned with Robb’s decisions.", "image": "Catelyn_Stark.png"},
            "Catelyn VII": {"content": "Catelyn VII: Catelyn is at the Red Wedding and is killed by the Freys.", "image": "Catelyn_Stark.png"},
        }
